    ...
    try {
      ...
      useEffect(() => {
        ...
        const handleRevoke = async (userId,id,student) => {
          try{
            const response = await axios.post(`${apiBaseUrl}/api/ce/in/RevokingIntern`,{userId,id,student})
            ...
            console.log("Error in Revoking the status ", error);
              const errorMsg = error.response ? error.response.data.msg : "Error in Revoking the status";
