...
const FacultyModal = ({rowData, open, handleClose, fetchUserData}) => {
    ...
    const handleRemarkChange = (event) => {
      ...
      const handleRemarkSubmit = () => {
        axios.post(`${apiBaseUrl}/api/ce/oc/toReject`, {remark, id: rowData.id })
          .then(response => {
        ...
        <Box sx={style}>
          ...
          <div className='field'>
            ...
            <div className='field'>
                ...
                <div className='fldData'><a style={{color:"black"}} href={rowData.certificate_url}>{rowData.certificate_url}</a></div>
            </div>
            <div className='field'>
