...
const OneCreditFacultyModal = ({
  ...
  const handleApprove = () => {
    axios
      .post(`${apiBaseUrl}/api/ce/oneCredit/ToApproveOneCredit`, {
        id: rowData.id,
  ...
  const handleRemarkSubmit = () => {
    axios
      .post(`${apiBaseUrl}/api/ce/oneCredit/ToRejectOneCredit`, {
        remark,
        id: rowData.id,
      })
      .then((response) => {
  ...
  return (
    <div>
        ...
        <Box sx={style}>
          ...
          <div>
            <div className="modal">
              ...
              {reviewed ? <div style={{marginTop:"10px"}}><StepperWithContent status={approvalStatus} rejection={rowData.rejected_by} data={approvalMembers} /></div> :
              ...
              {rowData.approval_status===-1 && <div><button className="btnApprove" onClick={()=> setRevokeNotify(true)} >Clear This Application</button></div>}
            </div>
          </div>
        </Box>
      </Modal>
      ...
      >
        <Box sx={style}>
              <div>If you Clear this Application then student can able to apply Again</div>
              <div style={{ display: "flex", gap: "20px", marginTop: "10px" }}>
              <div>
                <button className="conformBtnApprove" onClick={()=>handleRevokeRejection(rowData.id)}>
                  Yes
                </button>
              </div>
              <div>
